...
class egg_info(InfoCommon, Command):
    ...
    user_options = [
        ...
        ('tag-data', 'd', "Add data stamp (e.g. 20050528) to version number"),
        ('tag-build=', 'b', "Specify explicit tag to add to version number"),
        ('no-data', 'D', "Don't include data stamp [default]"),
    ]

    boolean_options = ['tag-data']
    negative_opt = {
        'no-data': 'tag-data',
    }
    ...
    def save_version_info(self, filename):
        """
        Materialize the value of data into the
